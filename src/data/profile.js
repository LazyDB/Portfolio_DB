export const profile = {
  ...
  phone: "+61 0433 959 821",
  email: "dipeshbaral2014@gmail.com",
  linkedin: "https://www.linkedin.com/in/dipesh-baral-25881b1b9/",
  github: "https://github.com/LazyDB",
  summary:
    "Software developer skilled in web technologies and computer science. Proficient in full-stack development with JavaScript, React, Vue, Node, and MongoDB. Effective collaborator, adept at resolving bugs and delivering features.",
  education: [
    {
  ...
  experience: [
    {
      ...
      bullets: [
        "Built front-end features using Vue.js, Vuex, and Vue Router.",
        "Developed and updated REST APIs with Node.js and MongoDB support.",
        "Fixed UI bugs with QA and improved component reliability.",
        "Helped implement company SSO and refactored legacy code.",
      ],
    },
  ],
  skills: [
